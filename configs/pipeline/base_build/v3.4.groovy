 ...
 *
 */
properties.x86.BASE.CI_BRANCH = 'v3.4_new_arm_modify_02'
properties.x86.BASE.DEPNAME = 'dailybuild_3.4_sequoiadb_x86'
...
properties.x86.CONFIGURE.DEPLOY_NODE = ['CI-A-27', 'CI-B-27', 'CI-C-27',]
properties.x86.CONFIGURE.ANT_TARGET = 'configure_test_build'
properties.x86.CONFIGURE.ANT_ARGS = [ISMVCC: true, BACKUP_LOG_WHEN_FAIL: false]
...
properties.x86.NORMAL_STANDALONE.ANT_ARGS = [DEPLOY_MODE: 'STANDALONE', BACKUP_LOG_WHEN_FAIL: false]
...
properties.x86.NORMAL_G3D3.DEPLOY_NODE = ['CI-A-25', 'CI-B-25', 'CI-C-25',]
properties.x86.NORMAL_G3D3.ANT_TARGET = 'normal_test_build'
properties.x86.NORMAL_G3D3.ANT_ARGS = [BACKUP_LOG_WHEN_FAIL: false]
...
properties.x86.SYNC.DEPLOY_NODE = ['CI-A-26', 'CI-B-26', 'CI-C-26',]
properties.x86.SYNC.ANT_TARGET = 'sync_test_build'
properties.x86.SYNC.ANT_ARGS = [BREAK_ON_FAILURE: true, BACKUP_LOG_WHEN_FAIL: false]
 ...
 *
 */
properties.arm64.BASE.CI_BRANCH = 'v3.4_new_arm_modify_02'
properties.arm64.BASE.DEPNAME = 'dailybuild_3.4_sequoiadb_arm64'
...
properties.arm64.CONFIGURE.EXEC_NODE = 'test_sequoiadb_arm_0'
properties.arm64.CONFIGURE.DEPLOY_NODE = ['CI-X-23', 'CI-Y-23', 'CI-Z-23',]
properties.arm64.CONFIGURE.ANT_TARGET = 'configure_test_build'
properties.arm64.CONFIGURE.ANT_ARGS = [ISMVCC: true, BACKUP_LOG_WHEN_FAIL: false]
...
properties.arm64.NORMAL_STANDALONE.ANT_ARGS = [DEPLOY_MODE: 'STANDALONE', BACKUP_LOG_WHEN_FAIL: false]
...
properties.arm64.NORMAL_G3D3.ANT_ARGS = [BACKUP_LOG_WHEN_FAIL: false]
...
properties.arm64.SYNC.DEPLOY_NODE = ['CI-X-22', 'CI-Y-22', 'CI-Z-22',]
properties.arm64.SYNC.ANT_TARGET = 'sync_test_build'
properties.arm64.SYNC.ANT_ARGS = [BREAK_ON_FAILURE: true, BACKUP_LOG_WHEN_FAIL: false]
